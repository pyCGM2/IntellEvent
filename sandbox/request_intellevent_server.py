...
from utils import fc_pred, fo_pred
import time
import threading
...
if __name__=='__main__':
    ...
    fc_pred (rs_fc_velo.tolist(), fc_traj[0:6], subject_name, start_frame, vicon)

    fo_pred (rs_fo_velo.tolist(), fc_traj[0:6], subject_name, start_frame, vicon)
